    ...
    <ion-content fullscreen scroll-y="true">
        <ion-grid class="wave-container">
            <ion-row class="ion-padding">
                ...
                <ion-col class="ion-align-self-start my-t" size="12" >
                    <ion-input placeholder="jhondoe@gmail.com" class="signup_input ion-margin-top "></ion-input>
                    <ion-input placeholder="Passord" class="signup_input ion-margin-top"></ion-input>
                    <div class="ion-text-end" style="margin-top:10px">
                        <ion-text class="ion-text-end forgetpassText" color="primary" @click="router.push('/password-reset')">Glemt passord?
                        </ion-text>
                    </div>
